...
# 檔案目錄設定
WORK_DIR = "./outputs"
BASE_IMG_PATH = "./custom_background.png"         # 您的通用底圖 (4570x2571)
ICON_DIR = "./"                      # SVG 天氣圖示資料夾
OUTPUT_DIR = os.path.join(WORK_DIR, "Output_368")

# 字體路徑
FONT_GEN_NORMAL = "./GenJyuuGothic-Normal.ttf"
FONT_YUAN_HEAVY = "./GenSekiGothic2TW-H2.ttf"
# 新增這行：設定王漢宗特黑體路徑
FONT_HANWANG_HEAVY = "./HanWangHeiHeavy.ttf"
# 並且在字型物件初始化區域新增：
# ==========================================
# 🛠 座標常數區 (已套用修正後的座標)
# ==========================================
